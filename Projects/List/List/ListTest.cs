   ...
   public class ListTest
    ...
    public void TestCount()
    {
      ...
      Assert.Equal(3, obj.Count);
        ...
        {
            List<int> obj = new List<int> { 6,8,1,0,5,2};
            Assert.Equal(4, obj.IndexOf(5));
        }
        [Fact]
        public void TestInsert()
        {
            List<int> obj = new List<int> { 6,8,5};
            obj.Insert(2, 21);
        ...
        {
            List<int> obj = new List<int> { 6, 8, 1, 0, 5, 2, 4, 11, 23};
            obj.Remove(1);
        ...
        {
            List<int> obj = new List<int> { 6, 8, 1, 41, 5, 2, 4, 11, 23 };
            obj.RemoveAt(3);
